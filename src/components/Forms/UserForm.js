...
function Formulario(){
    ...
    return(
        <>
            ...
            <form className="formCadastro" id="form1" onSubmit={e => handleSubmit(e)}>
                ...
                <div className="dados-pessoais">
                    ...
                    <div className="inputs">
                        ...
                        <input type="text" id="completeName" name="nome" minLength="3" maxLength="100" value={values.nome} onChange={handleChange}  onBlur={teste} required/>
                    ...
                    <div className="inputs">
                        ...
                        <MaskedInput name="cpf" id="cpfNumber" mask="999.999.999-99" value={values.cpf} onChange={handleChange}/>
                    ...
                    <div className="inputs">
                        ...
                        <input type="date" id="dataNasc" name="dataNasc" value={values.dataNasc} onChange={handleChange}  required/>
                ...
                <div className="cadastrais">
                    ...
                    <div className="inputs">
                        ...
                        <label htmlFor="contatNumber">Contato:</label>
                        <MaskedInput name="contatNumber" id="contatNumber" mask="(99) 9 9999-9999" value={values.contatNumber} onChange={handleChange}/>
                    ...
                    <div className="inputs">
                        ...
                        <input type="password" id="senha" name="senha" minLength="4" maxLength="15"  value={values.senha} onChange={handleChange} required/>
                    ...
                    <div className="inputs">
                        ...
                        <input type="password" id="confSenha" name="confSenha" minLength="4" maxLength="15" value={values.confSenha} onChange={handleChange} required/>
