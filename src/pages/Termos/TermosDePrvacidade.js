...
function TermosDePrivacidade(){
    return(
        <>
            <div className="terms">
                <h1 className="title">Política de privacidade para Corrente do Bem</h1>
                ...
                <h2 className="title">Os anúncios</h2>
                ...
                <h2 className="title">Os Cookies e Web Beacons</h2>
                ...
                <h2 className="title">Ligações a Sites de terceiros</h2>
